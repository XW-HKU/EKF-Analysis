clear;clc
syms p1 p2 p3 v1 v2 v3 a b c d a_s1 a_s2 a_s3 omega1 omega2 omega3 a_s1 a_s2 a_s3 a_s_11 a_s_12 a_s_13 a_s_21 a_s_22 a_s_23 a_s_31 a_s_32 a_s_33 tau1 tau2 tau3 tau_11 tau_12 tau_13 tau_21 tau_22 tau_23 ba1 ba2 ba3 bg1 bg2 bg3 l_ic1 l_ic2 l_ic3 g dt real;
...
%% distance estimation
X=[p;v;a_s;a_s_1;a_s_2;a_s_3;omega;tau;tau_1;tau_2;ba;bg;l_ic;ptheta];
dX=[dp;dv;da_s;da_s_1;da_s_2;da_s_3;domega;dtau;dtau_1;dtau_2;zeros(3,1);zeros(3,1);zeros(3,1);omega]
...
H(end-2:end,end-2:end)=cross_mat(R'*[1;0;0]);%[cross([1;0;0],[1 0 0]'),cross([1;0;0],[0 1 0]'),cross([1;0;0],[0 0 1]')]
